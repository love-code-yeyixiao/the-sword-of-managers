...
public class BlockMod {
	public static final Logger LOGGER = LogManager.getLogger(BlockMod.class);
	...
	public BlockMod() {
		...
		BlockModBlocks.REGISTRY.register(bus);
		BlockModItems.REGISTRY.register(bus);
		Mannge.register();
